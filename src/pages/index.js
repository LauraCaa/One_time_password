...
export default function Home() {
  ...
  function toggleIsRunning(value) {
    setIsRunning(value)
  };
  return (
    <main>
      <div>
        <h4>Few steps to complete your application</h4>
      ...
      <PasswordModal toggleIsOpen={toggleIsOpen} isOpen={isOpen} toggleIsRunning={toggleIsRunning} isRunning={isRunning}/>
    </main>
  );
}
